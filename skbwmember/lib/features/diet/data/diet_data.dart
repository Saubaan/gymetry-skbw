    ...
    timeSlots: [
      TimeSlot(
        ...
        foods: [
          ...
          Food(name: "Chapati with peanut butter", quantity: "1 chapati, 1 tbsp peanut butter", imagePath: "assets/diet/chapati_peanut_butter.png"),
        ],
      ),
      TimeSlot(
        time: "10:00 AM",
      ...
      TimeSlot(
        time: "7:30 PM",
        foods: [
          Food(name: "Egg whites", quantity: "6", imagePath: "assets/diet/egg_whites.png"),
          Food(name: "Egg yolk", quantity: "1", imagePath: "assets/diet/egg_yolk.png"),
        ],
      ),
      TimeSlot(
        time: "9:00 PM",
